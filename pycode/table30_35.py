...
class Data(Structure):
    ...
    _fields_ = [("member_1", c_uint16), #c_ubyte),
                ...
                ("member_14", c_char*28), #预留
                ("member_15", c_uint8), # 校验和
                ("member_16", c_uint8), # 帧尾
                ]
...
class SendData(Structure):
    ...
    _fields_ = [("member_1", c_uint16), #c_ubyte),
                ...
                ("member_14", c_char*28), #预留
                ("member_15", c_uint8), # 错误码
                ("member_16", c_uint8), # 校验和
                ("member_17", c_uint8), # 帧尾
                ]
...
while True:
    ...
    print(hex(data.member_9))
    print(hex(data.member_10))
    print(hex(data.member_11))
    print(hex(data.member_12))
    print(hex(data.member_13))
    print((data.member_14))
    print(hex(data.member_15))
    print(hex(data.member_16))
    ...
    data_ret.member_11 = data.member_11
    data_ret.member_12 = data.member_12
    data_ret.member_13 = data.member_13
    data_ret.member_14 = data.member_14  #预留
    data_ret.member_15 = 1 # 错误码
    data_ret.member_16 = data.member_15
    data_ret.member_17 = data.member_16
