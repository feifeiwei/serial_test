...
class SendData(Structure):
    ...
    _fields_ = [("member_1", c_uint16), #c_ubyte),
                ...
                ("member_11", c_uint16),
                ("member_12", c_char*27),
                ("member_13", c_uint8), #错误码
                ("member_14", c_uint8), # 校验和
...
while True:
    ...
    print((data.member_12))
    print(hex(data.member_13))
    print(hex(data.member_14))
    ...
    data_ret.member_13 = 1 # 错误码
    data_ret.member_14 = data.member_13
    data_ret.member_15 = data.member_14
